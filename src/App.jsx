...
const TAB_NAMES = {
  ...
  property:      'الاعتداء على الأملاك',
  regulatory:    'أحداث متعلقة بالتراتيب',
  terrorism:     'أحداث ذات صبغة إرهابية',
  security:      'أحداث أعوان قوات الأمن',
  unclassified:  'الأحداث غير المصنفة',
};
...
const CAT_MAP = {
  ...
  regulatory:    'أحداث متعلقة بالتراتيب',
  terrorism:     'أحداث ذات صبغة إرهابية',
  security:      'أحداث متعلقة بأعوان قوات الأمن الداخلي وبقية القوات الحاملة للسلاح',
